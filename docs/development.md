...
|------|------------------------|------------|-----------------|
|RF-001| A aplicação deve possuir uma página inicial pública, que apresente detalhes sobre a plataforma Trade Skills. Esta página deve conter os botões “Cadastre-se” e “Login”. | João | src/index.html |
|RF-002| A aplicação deve permitir o login por e-mail e senha. | Nome | caminho/para/arquivo | 
|RF-003| A aplicação deve permitir o cadastro com nome, e-mail e senha. | Nome | caminho/para/arquivo |
...
|RF-007| A aplicação deve permitir a busca por habilidades com filtros (categoria, reputação, palavras-chave e favoritos) e a visualização resumida dos perfis dos provedores. | Nome | caminho/para/arquivo |
